    ...
    <div className="pt-32 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          ...
          <p>
            1.2. Оператор / «Мы» / «Нас» — Индивидуальный предприниматель Беляев Дмитрий Алексеевич, ИНН 540362531499, ОГРН 325784700102583, адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О. Контакты: info@kingsley.moscow. Вопросы по обработке ПДн — privacy@kingsley.moscow.
          </p>
          <p>
